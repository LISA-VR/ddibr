<p align="center">
  ...
  <h3 align="center"><a href="https://dipot.ulb.ac.be/dspace/bitstream/2013/408743/3/ECCV_2026_dDIBR_ARMAND_LOSFELD.pdf">Paper</a> | <a href="https://lisa-vr.github.io/ddibr/">Project Page</a></h3>
    <!-- 
    <ul>
...
- [6. Interactive Viewer](#6-interactive-viewer)
- [7. Results](#7-results)
- [8. Standalone Installation Without NerfBaselines](#8-standalone-installation-without-nerfbaselines)
  * [8.1 Installation](#81-installation)
    + [8.1.1 Depth Submodules](#811-depth-submodules)
      - [8.1.1.1 ZoeDepth Installation](#8111-zoedepth-installation)
      - [8.1.1.2 DepthAnything3 Installation](#8112-depthanything3-installation)
  * [8.2 Optimization](#82-optimization)
  * [8.3 Standalone Viewer](#83-standalone-viewer)
- [9. Uninstallation](#9-uninstallation)
  * [9.1 Remove conda environment](#91-remove-conda-environment)
  * [9.2 Delete Nerfbaselines folder](#92-delete-nerfbaselines-folder)
  * [9.3 Optional: Cleaning conda cache](#93-optional--cleaning-conda-cache)
